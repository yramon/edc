...
def fn_1(comb, expanded_combis, feature_set, combis, explanations_sets):
    ...
    #take all combinations with the feature (set) to expand 
    ...
    for combi in combinations_to_expand_all_notpruned: #Pruning Step 1
        pruning=0
    ...
    #Pruning Step 2
    combinations_to_expand_pruned_bis=(combinations_to_expand_all-expanded_combinations_bis) #Prune expanded combis from the list
    ...
    return (new_combinations, combinations_to_expand, expanded_combis)