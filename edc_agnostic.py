...
Model-agnostic version of algorithm for finding Evidence Counterfactuals
...
class EDC_Explainer(object):
    ...
    def __init__(self, feature_names, classifier_fn, threshold_classifier, max_iter=50, max_explained=1, BB=True, max_features=30, time_maximum=300):
        ...
        Args:
            ...
            expressed in minutes. Default is set to 5 minutes.
        """
    ...
    def explanation(self, instance):
        ...
        tic=time.time()
        #INITIALIZATION
        instance=lil_matrix(instance) #more efficient format
        iteration=0
        nb_explanations=0
